...
public class TelegramClient extends TelegramLongPollingBot implements Input, Output {
    private ArrayDeque<Request> requests = new ArrayDeque<>();
    private String botUsername;
    private String botToken;

    public TelegramClient(Properties props) {
    ...
    public void sendMessage(List<String> messages, User user){
